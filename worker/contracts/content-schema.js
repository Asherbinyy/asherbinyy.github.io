        ...
        of: {
          ...
          fields: [
            ...
            },
            {
              key: 'shots',
              kind: 'list',
              label: 'App page screenshots',
              addLabel: 'Add a screenshot',
              consumer: 'live',
              help: 'Shown in this order on the application page. Each image can be opened full size.',
              of: {
                kind: 'asset',
                media: 'image',
                label: 'Screenshot',
        ...
        of: {
          ...
          fields: [
            ...
            },
            {
              key: 'picks',
              kind: 'list',
              label: 'Named favourites',
              addLabel: 'Add a favourite',
              consumer: 'live',
              help: 'Specific games, books or programmes, with their maker when one is supplied.',
              of: {
                kind: 'object',
                expand: 'inline',
                titleFrom: 'name',
                subtitleFrom: 'by',
                fields: [
                  localised('name', 'Name', {required: true}),
                  localised('by', 'By'),
                ],
              },
            },
