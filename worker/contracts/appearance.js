...
//
// A second contract in the same file, merged from `fix/ui-audit` on
// 2026-09-23. The proposal above describes settings the admin might offer; the
// allowlist below is what the app can already draw, versioned and held to
// `contracts/fixtures/appearance-v1.json` alongside
// `lib/app/theme/appearance_contract.dart`. The two share the storage ids
// `nocturne` and `daybreak` and nothing else, so neither changes the other.
// ---------------------------------------------------------------------------
