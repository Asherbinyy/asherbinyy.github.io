...
enum AscentSound {
  ...
  /// Another hundred metres of shaft behind you.
  reward('audio/reward.wav'),

  /// A run that beat the stored best.
...
/// ledger would otherwise have to carry for any of them. The three newest are
/// generated by `tool/audio/make_sounds.py`, which is in the repository, so
/// the set can be regenerated or extended without going looking for a pack.
///
