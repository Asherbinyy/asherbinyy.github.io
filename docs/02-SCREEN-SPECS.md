...
> Historical screen specification. The September 7 status block and diagrams below are not a current inventory. The wall, map treatment, intro, game and admin now have implementations, but are not visually accepted. Current observations: [audit](18-PROJECT-AUDIT.md). Current screen behaviors and acceptance: [F2–F3](19-FLUTTER-ENHANCEMENT-PLAN.md). Do not treat the existing code as automatically correct where the owner has rejected it.
