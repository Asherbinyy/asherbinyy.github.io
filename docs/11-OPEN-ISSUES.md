...
| ~~0e.17~~ | **Closed. The climber was taller than its own jump.** It was sized as a fraction of the shaft's width, which produced a creature 3.06m tall where ledges sit 2.6m apart and a bounce rises 2.75m: it filled the space it was trying to travel through, which is why the owner said it was too big and why the bouncing looked frantic. It is 1.15m now, sized in world metres like everything else, and three tests hold it against the ledge gap and the measured apex rather than against a pixel count. The two button systems on the screen are one. The shaft has torchlight and dust, so a paused game no longer looks like a screenshot. |
